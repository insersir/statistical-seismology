...
def StatisticalSeismology(Magnitude):
    # Histogram Normal
    fig = plt.figure()
    warna = fig.patch
    ...
    n, bins, patches = plt.hist(Magnitude, bins=bin_list, log=True, color='#808080', edgecolor='black',
    ...
    # print('Slope:',slope)
    plt.title('FMD for Phase 1', fontsize=13, fontweight='bold')
    plt.xlabel('Magnitude')
    plt.ylabel('Log10 (N)')
    ...
    plt.show()
    return (n, cum,bin_list, bvalue, avalue)